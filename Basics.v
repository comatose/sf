...
Module BinPlayground.
  ...
  Example test_bin_incr2: bin_to_nat (incr I) = S (bin_to_nat I).
  Proof.
    simpl.
    reflexivity.
  Qed.
  ...
  Example test_bin_incr4: bin_to_nat (incr (T I)) = S (bin_to_nat (T I)).
  Proof.
    simpl.
    reflexivity.
  Qed.
  ...
  Example test_bin_recovery1 : bin_to_nat (nat_to_bin O) = O.
  Proof. reflexivity. Qed.

  Example test_bin_recovery2 : bin_to_nat (nat_to_bin (S O)) = S O.
  Proof. reflexivity. Qed.

  Example test_bin_recovery3 : bin_to_nat (nat_to_bin (S (S O))) = S (S O).
  Proof. reflexivity. Qed.

  Example test_bin_recovery4 : bin_to_nat (nat_to_bin (S (S (S O)))) = S (S (S O)).
  Proof. reflexivity. Qed.
End BinPlayground.
